...
<body>
<nav class="navbar navbar-expand-md bg-body-tertiary bg-primary navbar-dark navH shadow  ">
  <div class="container-fluid">
    <a class="navbar-brand title" href="#">B<span>King</span>.</a>
...
<div class="landHome">
  <div class="container-kategori">
    <h3 class="subtitle-home">Pilihan Gedung<i class="fa-solid fa-building ik"></i></h3>
   ...
   <div class="containe text-centre text-md-left ">
    <div class="row  text-centre text-md-left">
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            <h5 class=" mb-4 font-weigth-bold titleFooter">B<span>King</span>.</h5>
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
          ...
          <p>
            <a href="" class="text-white" style="text-decoration:none;">Booking</a>
          </p>
...
<script src="<?= base_url('Asset\alumniCSSJS\scrip.js');?>"></script>
